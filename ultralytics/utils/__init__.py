...
def yaml_save(file="tomato_YOLOv8.yaml", data=None, header=""):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'tomato_YOLOv8.yaml'.
...
def yaml_load(file="tomato_YOLOv8.yaml", append_filename=False):
    """
